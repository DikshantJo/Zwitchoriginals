                ...
                <form @submit="handleSubmit($event, login)">
                    ...
                    <x-shop::modal ref="loginModel">
                        ...
                        <x-slot:footer>
                            ...
                            <div class="flex flex-wrap items-center gap-4">
                                <a href="{{ url('/customer/social-login/google') }}" class="w-full">
                                    <x-shop::button
                                        class="primary-button max-w-none flex-auto rounded-2xl px-11 py-3 max-md:rounded-lg max-md:py-1.5 w-full bg-red-600 hover:bg-red-700"
